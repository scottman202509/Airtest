...
class BaseClient(object):
    ...
    def http(self) -> HTTPRequest:
        ...
        def get(url, data: Optional[Dict] = None, timeout: Optional[float] = 60):
            return self._fetch("GET", url, data, timeout=timeout)
        def post(url, data: Optional[Dict] = None, timeout: Optional[float] = 60):
    ...
    def _session_http(self) -> HTTPSessionRequest:
        ...
        def fetch(method, url, data: Optional[Dict] = None, timeout: Optional[float] = 60):
        ...
        def delete(url, data: Optional[Dict] = None, timeout: Optional[float] = 60):
